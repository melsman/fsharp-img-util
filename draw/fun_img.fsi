...
val toColor   : fcolor -> System.Drawing.Color
val fromColor : System.Drawing.Color -> fcolor
...
val imgToBitmap : System.Drawing.Bitmap -> float -> fcolor image -> unit

// return a bitmap of the specified width and height; the float
// specifies the with and height of the image domain
val imgBitmap : float -> fcolor image -> int -> int -> System.Drawing.Bitmap
