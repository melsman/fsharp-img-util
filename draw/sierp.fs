...
let react (s:state) (k:System.Windows.Forms.KeyEventArgs) : state option =
  if k.KeyCode = System.Windows.Forms.Keys.Down then
    Some (min 10 (s+1))
  else if k.KeyCode = System.Windows.Forms.Keys.Up then
    Some (max 2 (s-1))
  else None
