...
let moveTest = move figTest (-20,20)
...
let makePicture filnavn figur b h =
  ...
  do ImgUtil.toPngFile (filnavn + ".png") bmp

do makePicture "figTest" figTest 100 150
do makePicture "moveTest" moveTest 100 150
do printfn "%A" (boundingBox figTest)
do printfn "%A" (boundingBox moveTest)
...
do makePicture "figHouse" figHouse 100 150
do printfn "%A" (boundingBox figHouse)
